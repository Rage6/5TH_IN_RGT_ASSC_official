...
class ReunionController extends Controller
{
    ...
    public function post(Request $request)
    {
      ...
      $request->validate([
        ...
        'phone_number' => 'string|required|min:10|max:16',
      ...
      foreach ($all_applicants as $one_applicant) {
        if ($one_applicant->first_name == $request->first_name && $one_applicant->last_name == $request->last_name && $one_applicant->type == 'reunion') {
          $original_date = $one_applicant->created_at;
          $expire_date = date_add($original_date,date_interval_create_from_date_string("1 hour"));
