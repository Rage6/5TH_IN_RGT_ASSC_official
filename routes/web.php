...
// Route::get('/', [App\Http\Controllers\WelcomeController::class, 'maintenance'])->name('maintenance');
...
Route::prefix('general-anderson-scholarship')->group(function() {
  Route::get('',[App\Http\Controllers\ScholarshipController::class,'index'])->name('scholarship.index');
});
...
Route::middleware('auth')->middleware('expiration')->group(function() {
  ...
  Route::prefix('/home')->group(function() {
    ...
    Route::get('download-all-bobcats', [App\Http\Controllers\HomeController::class,'bobcat_list_export_excel'])->name('bobcat.list.export');
    // Download the roster of all living Bobcats in HTML
    Route::get('download-all-bobcats-page', [App\Http\Controllers\HomeController::class,'bobcat_list_export_html'])->name('bobcat.list.html');
